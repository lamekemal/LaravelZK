...
<head>
    <meta charset="utf-8">
    <title>ZK Consulting - Article</title>
...
<body>
  ...
  ============================-->
    ...
    <main class="card" id="main" style="margin-right: 135px; margin-left: 135px; margin-top: 100px">

        <div style="margin:75px">
            <h2 style="margin-top: 15px">
                <strong> {{ $openformation->title }}</strong>
            </h2>

            <div style="margin-top:15px">
                <div class="about-image mt-70">
                    <img src="{{ URL::asset('images/' . $openformation->image_path) }}" alt="about">
                </div> <!-- faq image -->
            </div>
            ...
            <div align="center" style="margin-top:15px; width:100%; heigh: 700px">
                <embed style="width: 100%; height: 600px" src="{{ URL::asset('docs/' . $openformation->doc_path) }}"
