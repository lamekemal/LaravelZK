...
Route::get('/Questionnaires/{code}/questions/create', [QuestionController::class, 'create']);
Route::get('/Questionnaires/{code}/questions/create-qcu', [QuestionController::class, 'createQcu']);
Route::get('/Questionnaires/{code}/questions/create-qcm', [QuestionController::class, 'createQcm']);
Route::post('/Questionnaires/{code}/questions', [QuestionController::class, 'store']);
Route::post('/Questionnaires/{code}/questions-qcu', [QuestionController::class, 'storeQcu']);
Route::post('/Questionnaires/{code}/questions-qcm', [QuestionController::class, 'storeQcm']);
